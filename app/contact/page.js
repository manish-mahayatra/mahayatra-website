...
export default function page(){
    ...
    return (
        <section data-name="contact" className="contact-section">
            <div className="contact-container">
                <div className="contact-info">
                    <h2 className="contact-title">Get in Touch</h2>
                    <p className="contact-subtitle">We'd love to hear from you. Please fill out this form or use our contact information.</p>
