...
export default function About() {
    ...
    return (
        <section data-name="why-choose-us" className="section-padding">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 className="section-title">Why Choose Us</h2>
                <p className="section-subtitle">Discover what makes us the perfect choice for your travel needs</p>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {reasons.map((reason, index) => (
                        <div key={index} className="text-center">
                            <div className="inline-block p-4 rounded-full bg-blue-100 mb-4">
                                <i className={`fas ${reason.icon} text-3xl text-blue-600`}></i>
                            </div>
